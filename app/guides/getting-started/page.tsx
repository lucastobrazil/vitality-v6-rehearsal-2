...
export default function GettingStarted() {
  ...
  return (
    <article className="space-y-8">
      ...
      <section>
        <h2 className="text-xl font-semibold tracking-tight">Initial setup</h2>
...
npx shadcn@latest add ${base}/r/spinner.json`}</code>
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Browse every component via the sidebar.
        </p>
      </section>

      <section>
        <h2 className="text-xl font-semibold tracking-tight">Use with a shadcn-aware MCP client</h2>
